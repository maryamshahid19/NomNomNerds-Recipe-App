...
class SearchScreen extends StatelessWidget {
  SearchScreen({Key? key, required this.searched, required this.userid})
      : super(key: key);
  ...
  Future<List<SearchedRecipeCard>> displaySearchedRecipe(
      BuildContext context, String searched) async {
    List<RecipenolistModel> returned = await search(searched);

    List<SearchedRecipeCard> recipeCards = [];
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    FutureBuilder<List<SearchedRecipeCard>>(
                      future: displaySearchedRecipe(context, searched),
