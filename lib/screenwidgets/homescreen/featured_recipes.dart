...
class FeaturedRecipe extends StatelessWidget {
  ...
  Future<List<FeaturedRecipeCard>> displayRecommendedRecipe(
      BuildContext context, int userid) async {
    List<RecipenolistModel> returned =
        await DatabaseHelper.getRecipesyoumaylike(userid);

    List<FeaturedRecipeCard> recipeCards = [];
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          FutureBuilder<List<FeaturedRecipeCard>>(
